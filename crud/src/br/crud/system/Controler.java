...
public class Controler {
	...
	public br.hibernate.domain.Bean loadById(Class<? extends br.hibernate.domain.Bean> klass, String propretyName, Serializable id) throws Exception{
		HibernateOperation hibernateOperation = new HibernateOperation();
		return (br.hibernate.domain.Bean) hibernateOperation.loadById(klass, propretyName, id);
	}
