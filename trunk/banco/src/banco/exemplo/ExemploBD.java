...
public class ExemploBD {
	 ...
	 *
	 * Este exemplo testa os componentes básicos do driver JDBC, e mostra a
	 * implementação de comandos simples.
	 *
	 * Para utilizar este exemplo é necessário um banco de dados existente, onde
	 * é criada uma tabela chamada tbl_basica.
	 *
	...
	public static void main(String args[]) {
		System.out.println("MySql - Teste básico v6.3 rev 1\n");
